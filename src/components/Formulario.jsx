    ...
    return (
        ...
        <form className="bg-white py-10 px-5 mb-10 lg:mb-0 shadow-md rounded-md" onSubmit={handleSubmit}>
            ...
            <div className="mb-5">
                ...
                <input type="email" id="email" placeholder="Email del propietario" className="border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md" 
            ...
            <div className="mb-5">
                ...
                <textarea id="sintomas" placeholder="Describe los síntomas que presenta tu mascota" className="border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md" value={sintomas} onChange={e => setSintomas(e.target.value) }/>
            </div>
